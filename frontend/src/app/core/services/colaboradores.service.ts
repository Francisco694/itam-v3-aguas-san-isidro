...
import { Colaborador, ColaboradorFilters, ColaboradorInput, InventarioColaborador, InventarioConciliadoColaborador, PendienteOffboarding } from '../models/itam.models';
...
export class ColaboradoresService {
  ...
  inventarioConciliado(id:string){return this.http.get<ApiItemResponse<InventarioConciliadoColaborador>>(`${this.url}/${id}/inventario-conciliado`).pipe(map(r=>r.data));}
