...
export class DispositivoDetail implements OnInit {
  ...
  protected actionTitle(): string { return { 'assign-person': 'Generar Asignación', 'assign-department': 'Asignar a Departamento', return: 'Registrar Devolución', state: 'Cambiar Estado', recover: 'Registrar equipo encontrado', service:'Enviar a Servicio Técnico',retire:'Dar de Baja' }[this.action() || 'return']; }
